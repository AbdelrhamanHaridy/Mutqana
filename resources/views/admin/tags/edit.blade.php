                ...
                <div class="breadcrumb justify-content-center">
                    <div class="breadcrumb-elements-item dropdown p-0">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{route('tags.create')}}" class="dropdown-item"><i class="icon-price-tag2"></i>إضافة العلامات جديد</a>
                            <a href="{{route('tags.edit',$model->id)}}" class="dropdown-item"><i class="icon-pencil5"></i>تعديل العلامات</a>
                            {!! Form::open([
                                'style' => 'display: inline-block;',
                                'method' => 'DELETE',
                                'onsubmit' => "return confirm('".trans("هل أنت متأكد من حذف $model->name ؟")."');",
                                'route' => ['tags.destroy', $model->id]])
                            !!}
                            <button class="dropdown-item"><i class="icon-trash-alt" style="color: #fa0000"></i>حذف العلامات</button>
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('tags.update',$model->id)}}" method="POST" files="true" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
