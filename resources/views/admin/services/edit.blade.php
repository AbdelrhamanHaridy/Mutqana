                ...
                <div class="breadcrumb justify-content-center">
                    <div class="breadcrumb-elements-item dropdown p-0">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{route('services.create')}}" class="dropdown-item"><i class="icon-wrench3"></i>إضافة الخدمات جديد</a>
                            <a href="{{route('services.edit',$model->id)}}" class="dropdown-item"><i class="icon-pencil5"></i>تعديل الخدمات</a>
                            {!! Form::open([
                            ...
                            !!}
                            <button class="dropdown-item"><i class="icon-trash-alt" style="color: #fa0000"></i>حذف الخدمات</button>
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('services.update',$model->id)}}" method="POST" files="true" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
