        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-3">عنوان الأيقون <span class="text-danger">*</span></label>
            <div class="col-lg-9">
                <div class="form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <input type="text" name="{{$inputTitle}}" id="title" class="form-control maxlength-badge-position @error($inputTitle) border-danger-400 @enderror" placeholder="عنوان الأيقونة" value="{{Request::old($inputTitle) ? Request::old($inputTitle) : $model->$inputTitle}}" required>
                        @error($inputTitle)
        ...
        <!-- Start text ar input -->
        @php $InputText = "text"; @endphp
        <div class="form-group row">
            <label class="col-form-label col-lg-3">وصف الأيقونة  <span class="text-danger">*</span></label>
            <div class="col-lg-9">
                <textarea name="{{$InputText}}" class="form-control summernote" rows="4" cols="4">{{Request::old($InputText) ? Request::old($InputText) : $model->$InputText}}</textarea>
            </div>
        </div><!-- End text ar input -->
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <select name="{{$input}}" data-placeholder="إختر حالة الأيقونة" class="form-control select" required data-fouc>
