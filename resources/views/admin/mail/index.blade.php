...
@section('navbar-nav')
    <li class="nav-item">
        <a href="#" class="navbar-nav-link sidebar-control sidebar-secondary-toggle d-none d-md-block sidebarSecondaryNav">
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    @if($request->keyword)
                        <a href="{{route('mail.index')}}" class="breadcrumb-item"><i class="icon-drawer-in"></i> البريد الوارد</a>
                    @endif
                    <span class="breadcrumb-item active">@if($request->keyword){{Request::old('keyword') ? Request::old('keyword') : $request->keyword}}
                        @else
                            <span class="breadcrumb-item active"><i class="icon-drawer-in"></i> البريد الوارد</span>
                        @endif
                    </span>
                </div>
             </div>
