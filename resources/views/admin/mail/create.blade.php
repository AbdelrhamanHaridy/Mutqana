...
@section('navbar-nav')
    <li class="nav-item">
        <a href="javascript:void(0);" class="navbar-nav-link sidebar-control sidebar-secondary-toggle d-none d-md-block">
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    <a href="{{route('admin.index')}}" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> الرئيسية</a>
                    <a href="{{route('mail.index')}}" class="breadcrumb-item"><i class="icon-drawer-in"></i> صندوق الوارد</a>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td class="align-top py-0">
                                    <div class="d-sm-flex flex-sm-wrap">
                                        <input name="name" type="text" value="{{old('name')}}" class="form-control flex-fill w-auto py-2" required placeholder="الأسم">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="align-top py-0">
                                    <div class="d-sm-flex flex-sm-wrap">
                                        <input name="phone" type="text" value="{{old('phone')}}" class="form-control flex-fill w-auto" required placeholder="اكتب رقم الهاتف">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="align-top py-0">
                                    <div class="d-sm-flex flex-sm-wrap">
                                        <input name="mail" type="email" value="{{old('mail')}}" class="form-control flex-fill w-auto py-2" required placeholder="أضف المستلمين">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="align-top py-0">
                                    <input name="subject" type="text" value="{{old('subject')}}" class="form-control py-2" required placeholder="أضف موضوعك">
                                </td>
                            </tr>
                            <tr>
                                <div class="d-sm-flex flex-sm-wrap">
                                    <input required name="is_sender" type="hidden" value="1">
                                    <input required name="is_read" type="hidden" value="1">
                                </div>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="card-body p-0">
                        <div class="overflow-auto mw-100">
                            <textarea  name="message" rows="3" cols="3" class="form-control summernote flex-fill w-auto " required> {{old('message')}}</textarea>
                        </div>
                    </div><!-- /mail container -->
                    </form>
                </div><!-- /single mail -->
