    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">   قراءة رسالة "{{$contact_us->name}} "</span>
            </div>
        </div>
    </div>
</div><!-- /page header -->
    ...
    <div class="d-md-flex align-items-md-start">
        ...
        <div class="flex-fill overflow-auto">
            ...
            <div class="card">
                ...
                <div class="navbar navbar-light bg-light navbar-expand-lg py-lg-2 rounded-top">
                    ...
                    <div class="navbar-collapse text-center text-lg-left flex-wrap collapse" id="inbox-toolbar-toggle-read">
                        <div class="mt-3 mt-lg-0 mr-lg-3">
                            <div class="btn-group">
                                {!! Form::open([
                                    'action' => ['App\Http\Controllers\Admin\MailController@destroy',$contact_us->id],
                                    'method' => 'delete'
                                ])!!}
                ...
                <div class="card-body">
                    <div class="media flex-column flex-md-row">
                        ...
                        <div class="media-body">
                            <h6 class="mb-0" title="الموضوع">{{$contact_us->subject}}</h6>
                            <div class="letter-icon-title font-weight-semibold" title="اسم المرسل">{{$contact_us->name}} - <a href="tel:{{$contact_us->phone}}" title="رقم الهاتف">{{$contact_us->phone}}</a><a href="mailto:{{$contact_us->mail}}" title="البريد الإلكتروني"> - {{$contact_us->mail}}</a></div>
                        </div>
                    </div>
                </div><!-- /mail details -->
                ...
                <!-- Mail container -->
                <div class="card-body">
                    <div class="overflow-auto mw-100" title="الرسالة">
                       {!! $contact_us->message !!}
                    </div>
                </div><!-- /mail container -->
            </div><!-- /single mail -->
