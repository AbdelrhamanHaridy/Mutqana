    ...
    <div class="page-header border-bottom-0">
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> -   تعديل حول الموقع {{$model->name_شق}}</h4>
            </div>
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('about.update',$model->id)}}" method="POST" files="true" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
